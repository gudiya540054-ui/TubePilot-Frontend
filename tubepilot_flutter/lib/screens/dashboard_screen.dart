                          ...
                          children: [
                            ...
                            Expanded(
                              child: OutlinedButton(
                                ...
                                child: Text(context.tr('Wallet'), style: const TextStyle(fontWeight: FontWeight.w700, fontSize: 13)),
                              ),
                            ),
                            ...
                            Expanded(
                              child: ElevatedButton(
                                ...
                                child: Text(context.tr('Subscription'), style: const TextStyle(fontWeight: FontWeight.w800, fontSize: 13)),
                              ),
                            ),
                          ],
                        ),
